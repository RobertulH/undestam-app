...
const seed = [
  { title: "Caut pensiune aproape de pârtie (Poiana Brașov)", location: "Brașov / Poiana", type: "Pensiune", people: 3, budget: "300–450 lei/noapte", fac: ["aproape de pârtie", "mic dejun", "parcare"], details: "2 nopți, familie cu copil. Vrem liniște și acces rapid la pârtie.", status: "new" as StatusKey },
  { title: "Caut cabană cu priveliște (Râșnov/Bran)", location: "Râșnov / Bran", type: "Cabană", people: 6, budget: "", fac: ["liniște", "parcare"], details: "Grup de prieteni, weekend. Ideal cu foișor și vedere.", status: "talking" as StatusKey },
  { title: "City break Brașov — pet-friendly", location: "Brașov", type: "Hotel", people: 2, budget: "", fac: ["pet-friendly"], details: "Venim cu un cățel mic. Preferăm aproape de centru.", status: "booked" as StatusKey },
];

export default function ZonaBrasov() {
  ...
  return (
    <div style={{ minHeight: "100vh", padding: 18, background: "#0b1220", color: "#e8eefc", fontFamily: "system-ui" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <h1 style={{ marginTop: 10, marginBottom: 8 }}>Caut cazare în Brașov</h1>
        <p style={{ color: "#a9b7d6", lineHeight: 1.7 }}>
          Cereri active pentru Brașov, Poiana Brașov, Bran, Râșnov și împrejurimi.
        </p>

        <div style={{ marginTop: 12, display: "flex", gap: 10, flexWrap: "wrap" }}>
          <input value={q} onChange={(e) => setQ(e.target.value)} placeholder="caută: pârtie, Poiana..." style={{ borderRadius: 12, padding: 10, border: "1px solid rgba(255,255,255,.1)", background: "rgba(255,255,255,.04)", color: "#e8eefc", minWidth: 240 }} />
