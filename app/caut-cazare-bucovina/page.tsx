...
const seed = [
  { title: "Caut pensiune tradițională (mic dejun inclus)", location: "Bucovina", type: "Pensiune", people: 2, budget: "250–400 lei/noapte", fac: ["mic dejun", "parcare"], details: "Vrem zonă liniștită, aproape de mănăstiri.", status: "new" as StatusKey },
  { title: "Caut cabană pentru grup (grătar/foișor)", location: "Gura Humorului", type: "Cabană", people: 8, budget: "", fac: ["parcare", "liniște"], details: "Weekend cu prieteni. Ideal aproape de pârtie/activități.", status: "talking" as StatusKey },
  { title: "Weekend relaxare — pet-friendly", location: "Vatra Dornei", type: "Vilă", people: 3, budget: "", fac: ["pet-friendly"], details: "Venim cu câine. Preferăm curte și liniște.", status: "booked" as StatusKey },
];

export default function ZonaBucovina() {
  ...
  return (
    <div style={{ minHeight: "100vh", padding: 18, background: "#0b1220", color: "#e8eefc", fontFamily: "system-ui" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <p style={{ color: "#a9b7d6", lineHeight: 1.7 }}>Cereri active pentru Bucovina: Gura Humorului, Vatra Dornei, Suceava și împrejurimi.</p>

        <div style={{ marginTop: 12, display: "flex", gap: 10, flexWrap: "wrap" }}>
          <input value={q} onChange={(e) => setQ(e.target.value)} placeholder="caută: mănăstiri, tradițional..." style={{ borderRadius: 12, padding: 10, border: "1px solid rgba(255,255,255,.1)", background: "rgba(255,255,255,.04)", color: "#e8eefc", minWidth: 240 }} />
